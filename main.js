...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function loadNav() {
    ...
    <li class="nav-item">
      <a class="nav-link" aria-current="page" href="https://bloxco.org">Home</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" aria-current="page" href="https://bloxco.org/ranks">Rank Purchase</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" aria-current="page" href="https://bloxco.org/partners">Partners</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" aria-current="page" href="https://bloxco.org/partner-req">Partnership Requirements</a>
    ...
    <li class="nav-item dropdown important-links">
      ...
      <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="https://bloxco.org/events" target="_blank">Event Calendar</a></li>
      </ul>
    </li>
      </ul>
    `;
